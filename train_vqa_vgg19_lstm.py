...
model.save(f"./Keras models/{IMG_FEATURE_MODEL}_{TEXT_MODEL_USED}_SGD_optimizer-run{NUM_EPOCHS}epochs.keras")
model.save(f"./H5 models/{IMG_FEATURE_MODEL}_{TEXT_MODEL_USED}_SGD_optimizer-run{NUM_EPOCHS}epochs.h5")
print("model saved")


plot_history(history, f"./PNG files/{IMG_FEATURE_MODEL}_{TEXT_MODEL_USED}_SGD_optimizer-run{NUM_EPOCHS}epochs.png")
